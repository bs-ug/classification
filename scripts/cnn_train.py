...
embedding_matrix, word_index, train_seq_x, validation_seq_x = get_word_embeddings(
    os.path.join(settings.MODELS_PATH, settings.CNN_MODEL_NAME), train_x, validation_x, median_article_length)
...
# model_name="cnn_cnn.hdf5"
# batch_size=128
# epochs=50
# log_dir = os.path.join(settings.DATA_DIR, "logs",
#                        f"cnn-{model_name.split('.')[0]}-{settings.CNN_MODEL_NAME.split('.')[0]}-{batch_size}-{epochs}"
