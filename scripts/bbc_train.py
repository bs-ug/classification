...
embedding_matrix, word_index, train_seq_x, validation_seq_x = get_word_embeddings(
    os.path.join(settings.MODELS_PATH, settings.BBC_MODEL_NAME), train_x, validation_x, median_article_length)
