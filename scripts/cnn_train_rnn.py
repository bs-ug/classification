...
embedding_matrix, word_index, train_seq_x, validation_seq_x = get_word_embeddings(os.path.join(settings.CNN_MODEL_PATH, settings.CNN_MODEL_NAME), train_x, validation_x)

classifier = cnn(word_index, embedding_matrix)
accuracy = train_model(classifier, train_x, train_y, validation_x, validation_y)
